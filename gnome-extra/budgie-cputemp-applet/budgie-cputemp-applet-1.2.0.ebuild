...
DESCRIPTION="This applet shows a system temperature. Made for Budgie Desktop."
HOMEPAGE="https://github.com/tarkah/${PN}"
SRC_URI="https://github.com/tarkah/${PN}/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz"
