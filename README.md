**UPDATE December 5th '24: Small update, I know I am late with the promised fixes but they are almost here.. In a nutshell after fully reinstall gentoo and getting budgie to work with a complete barebone system I have fixed the ebuilds pertaining to 10.8.2. I will update these ebuilds here very soon once I done some final checks. After that work on 10.9.2 will start and should follow in the next  2 weeks after that. Once again sorry for all the delays but they are almost over!! (yay!!) ~ Sarah**
