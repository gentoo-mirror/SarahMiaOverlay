...
DESCRIPTION="Budgie Desktop compositing window manager softforked from Mutter 43"
...
DEPEND="
	...
	wayland? (
		...
		x11-libs/libdrm
		>=media-libs/mesa-21.3[egl(+),gbm(+),wayland]
	...
	x11-wm/mutter:=
"
# Mutter added as dependency so it can coexist with other gnome based de's without file conflicts, being a softfork it relies on some shared files between the two..
